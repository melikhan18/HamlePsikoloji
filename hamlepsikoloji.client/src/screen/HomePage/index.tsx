...
function Index() {
    return (
        <>
            {/* <nav id="navScroll" className="navbar navbar-expand-lg navbar-light fixed-top scrolled shadow-sm" tabIndex={0}>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className="nav-link" href="#services" aria-label="Brings you to the frontpage">
                                    Services
                                </a>
                            </li>
                            <li className="nav-item">
                        ...
                        <a href="https://templatedeck.com/stride-html-template.html" data-splitbee-event="Click Download"
                            aria-label="Download this template" className="link-dark pb-1 link-fancy me-2">
            ...
            <main>
                    ...
                    <div className="container position-relative">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-7 py-vh-6 position-relative" data-aos="fade-right">
                                ...
                                <p className="lead">To be honest, this is just a stupid placeholder text. We don´t know how to sell anything,
                    ...
                    <div className="container">
                        <div className="row d-flex justify-content-end">
                            <div className="col-lg-8" data-aos="fade-down">
                                <h2 className="display-6">Okay, there are three really good reasons for us. There are no more than three, but we
                        ...
                        <div className="row d-flex align-items-center">
                            <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <h3 className="py-5 border-top border-dark">We rented this fancy startup office in an old factory building.</h3>
                                ...
                                <a href="#" className="link-fancy">Learn more
                                </a>
                            </div>

                            <div className="col-md-6 col-lg-4 py-vh-4 pb-0" data-aos="fade-up" data-aos-delay="400">
                                <span className="h5 fw-lighter">02.</span>
                                <h3 className="py-5 border-top border-dark">We don´t know exactly what we are doing. But thats good because we
                            ...
                            <div className="col-md-6 col-lg-4 py-vh-6 pb-0" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <h3 className="py-5 border-top border-dark">There is no real number three reason. So please read again number
                                    one and two.</h3>
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minus culpa, voluptatibus ex itaque, sapiente a
                                    consequatur inventore beatae, ipsam debitis omnis consequuntur iste asperiores. Similique quisquam debitis
                                    corrupti deserunt, dolor.</p>
                            ...
                            <div className="col-lg-6">
                                <div className="row gx-5 d-flex">
                                    <div className="col-md-11">
                                        <div className="shadow ratio ratio-16x9 rounded bg-cover bp-center align-self-end" data-aos="fade-right"
                                            style={{ backgroundImage: "url(public/img/webp/people15.webp)", aspectRatio: "50%" }}>
                                        </div>
                                    </div>
                                    <div className="col-md-5 offset-md-1">
                                        <div className="shadow ratio ratio-1x1 rounded bg-cover mt-5 bp-center float-end" data-aos="fade-up"
                                            style={{ backgroundImage: "url(/public/img/webp/interior42.webp)" }}>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="col-12 shadow ratio rounded bg-cover mt-5 bp-center" data-aos="fade-left"
                                            style={{ backgroundImage: "url(/public/img/webp/people4.webp);--bs-aspect-ratio: 150%" }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4">
                                <h3 className="py-5 border-top border-dark" data-aos="fade-left">We did some interesting stuff in our field of
                                ...
                                <p>
                                    <a href="#" className="link-fancy link-dark" data-aos="fade-left" data-aos-delay="400">Learn more
                                    </a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row d-flex justify-content-between align-items-center">
                            <div className="col-lg-5">
                                <h3 className="py-5 border-top border-dark" data-aos="fade-right">Our magic numbers</h3>
                            </div>
                            <div className="col-lg-6">
                                <div className="row">
                                    <div className="col-12">
                                        <h2 className="display-6 mb-5" data-aos="fade-down">There are some important numbers for us. They are just
                                            numbers without any meaning, but we just love them.</h2>
                                    </div>
                                    <div className="col-lg-6" data-aos="fade-up">
                                        <div className="display-1 fw-bold py-4">42%</div>
                                        <p className="text-black-50">Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac
                            ...
                            <div className="col-12">
                                <div className="row vw-100 px-0 py-vh-5 d-flex align-items-center scrollx">
                                    <div className="col-md-2" data-aos="fade-up">
                                        <img src="/public/img/webp/interior37.webp" className="rounded shadow img-fluid" alt="nice gallery image"
                                            width="512" height="341" />
                                    </div>

                                    <div className="col-md-2" data-aos="fade-up" data-aos-delay="200">
                                        <img src="/public/img/webp/people1.webp" className="img-fluid rounded shadow" alt="nice gallery image" width="1164"
                                            height="776" />
                                    </div>

                                    <div className="col-md-3" data-aos="fade-up" data-aos-delay="400">
                                        <img src="/public/img/webp/people2.webp" className="img-fluid rounded shadow" alt="nice gallery image" width="844"
                                            height="1054" />
                                    </div>

                                    <div className="col-md-3" data-aos="fade-up" data-aos-delay="600">
                                        <img src="/public/img/webp/interior29.webp" className="img-fluid rounded shadow" alt="nice gallery image"
                                            width="844" height="562" />
                                    </div>

                                    <div className="col-md-2" data-aos="fade-up" data-aos-delay="800">
                                        <img src="/public/img/webp/people23.webp" className="rounded shadow img-fluid" alt="nice gallery image" width="512"
                                            height="341" />
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container py-vh-4 w-100 overflow-hidden">
                    <div className="row d-flex justify-content-center align-items-center">
                        <div className="col-lg-5">
                            <h3 className="py-5 border-top border-dark" data-aos="fade-right">What our clients say</h3>
                        </div>
                        <div className="col-md-7" data-aos="fade-left">
                            <blockquote>
                                <div className="fs-4 my-3 fw-light pt-4 border-bottom pb-3">“I´am the CEO of this company. So maybe you think
                                ...
                                <img src="/public/img/webp/person11.webp" width="64" height="64" className="img-fluid rounded-circle me-3" alt=""
                                    data-aos="fade" />
                                <span><span className="fw-bold">John Doe,</span>
                        ...
                        <div className="row d-flex justify-content-center">
                            <div className="row d-flex justify-content-center text-center">
                                <div className="col-lg-8 text-center" data-aos="fade">
                                    <p className="text-secondary lead">Let´s start a project together!</p>
                                    <h2 className="display-6 mb-5">Hell no! This button is linked to a none working contact form. A none working
                                ...
                                <div className="col-12">
                                    <a href="#" className="btn btn-warning btn-xl shadow me-3 mt-4" data-aos="fade-down">Get in contact</a>
                                </div>
                            </div>
                    ...
                    <div className="container py-vh-6">
                        <div className="row d-flex justify-content-center">
                            <div className="col-12 col-lg-10 col-xl-8 text-center">
                                <h2 className="display-6">Loved by people all around the globe</h2>
                                <p className="lead">Our spaces and offices are soooooo lovely, no one would give us a negative rating! And look
                            ...
                            <div className="col-12 mt-4">
                                <div className="row row-cols-1 row-cols-md-2 g-5 d-flex align-items-center">
                                    ...
                                    <div className="col-12 col-lg-6 col-xl-4" data-aos="fade-right">
                                        <div className="card p-4 mt-3 border-0">
                                            <div className="card-body">
                                                <div className="text-dark py-2 fs-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                <div className="d-flex justify-content-between border-top pt-3">
                                                    <div>
                                                        ...
                                                        <small className="text-muted">COO, The Boo Corp.</small>
                                                    </div>
                                                    <img src="img/webp/person9.webp" width="48" height="48" className="rounded-circle" alt=""
                                                        data-aos="fade" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-12 col-lg-6 col-xl-4">
                                        <div className="card p-4 shadow mt-3 border-0" data-aos="fade-down">
                                            <div className="card-body">
                                                <div className="text-dark py-2 fs-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" className="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path
                                                ...
                                                <div className="d-flex justify-content-between border-top pt-3">
                                                    <p className="card-text">
                                                        <span className="h6 fw-5">Jenny Matrix</span><br />
                                                        <small className="text-muted">Daughter of Col. John Matrix, Commando.</small>
                                                    </p>
                                                    <img src="img/webp/person3.webp" width="48" height="48" className="rounded-circle" alt=""
                                                        data-aos="fade" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-12 col-lg-6 col-xl-4">
                                        <div className="card p-4 mt-3 border-0" data-aos="fade-left">
                                            <div className="card-body">
                                                ...
                                                <div className="d-flex justify-content-between border-top pt-3">
                                                    <p className="card-text">
                                                        <span className="h6 fw-5">Rustin Cohle</span><br />
                                                        <small className="text-muted">Detective, Somewhere in the swamps</small>
                                                    </p>
                                                    <img src="img/webp/person8.webp" width="48" height="48" className="rounded-circle" alt=""
                                                        data-aos="fade" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-12 col-lg-6 col-xl-4">
                                        <div className="card p-4 mt-3 border-0" data-aos="fade-right">
                                            <div className="card-body">
                                                ...
                                                <div className="d-flex justify-content-between border-top pt-3">
                                                    <p className="card-text">
                                                        <span className="h6 fw-5">Richard Thornburg</span><br />
                                                        <small className="text-muted">News Reporter, KFLW-TV</small>
                                                    </p>
                                                    <img src="img/webp/person14.webp" width="48" height="48" className="rounded-circle" alt=""
                                                        data-aos="fade" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-12 col-lg-6 col-xl-4">
                                        <div className="card p-4 mt-3 border-0" data-aos="fade-up">
                                            <div className="card-body">
                                                ...
                                                <div className="d-flex justify-content-between border-top pt-3">
                                                    <p className="card-text">
                                                        <span className="h6 fw-5">Harry Walters</span><br />
                                                        <small className="text-muted">Gangster, In Bruges</small>
                                                    </p>
                                                    <img src="img/webp/person13.webp" width="48" height="48" className="rounded-circle" alt=""
                                                        data-aos="fade" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-12 col-lg-6 col-xl-4">
                                        <div className="card p-4 shadow mt-3 border-0" data-aos="fade-left">
                                            <div className="card-body">
                                                <div className="text-dark py-2 fs-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" className="bi bi-star-fill" viewBox="0 0 16 16">
                                                    <path
                                                ...
                                                <div className="d-flex justify-content-between border-top pt-3">
                                                    <p className="card-text">
                                                        <span className="h6 fw-5">Lizzie Stark</span><br />
                                                        <small className="text-muted">Head of Security, Brummagem Boys</small>
                                                    </p>
                                                    <img src="img/webp/person18.webp" width="48" height="48" className="rounded-circle" alt=""
                                                        data-aos="fade" />
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="small py-vh-3 w-100 overflow-hidden">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-6 col-lg-4 border-end" data-aos="fade-up" data-aos-delay="200">
                                <div className="d-flex">
                ...
                <div className="container py-vh-3 border-top" data-aos="fade" data-aos-delay="200">
                    <div className="row d-flex justify-content-center">
                                    ...
                                    <div className="row">
                                        <div className="col">
                                            <form className="form-floating">
                                                ...
                                                <input type="email" className="form-control p-3" id="floatingInput" placeholder="name@example.com"></input>
                                            </form>
                                        </div>
                                        <div className="col-auto">
                                            <a href="#" className="btn btn-dark py-3 px-5">Subscribe</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
